...
function displayPics(){
  ...
  // because when we set it to `let` it made it scope to just the while block, so when something outside of that is asking for that let item. it does not know what to look for.
  console.log(viewed)
