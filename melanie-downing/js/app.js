...
function displayPics(){
  ...
  // console.log(rando); removed due to error

  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
  // This threw an error because `let` is locally scoped and will not work outside of this function. If console.log(rando) is moved to be between the first and secons closing curly brace, this will work. Removing the line also works.
  console.log(viewed)
