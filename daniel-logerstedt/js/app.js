...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The scoping is wrong, when declared with let the variable only exists inside the while statement block. Using let still allows the variable to function inside it's local scope but unlike before when var was used the variable is only stored during the time the block containing it is executed, therefore the console log after the block will throw an error because the variable no longer exists.
  console.log(viewed)
